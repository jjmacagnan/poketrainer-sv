  ...
  pt: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { name: "Chorizo", detail: "Normal-type Sparkling Lv. 3" },
          { name: "Pimentão Vermelho", detail: "Fire-type Sparkling Lv. 3" },
          { name: "Pepino", detail: "Water-type Sparkling Lv. 3" },
          { name: "Alface", detail: "Grass-type Sparkling Lv. 3" },
          { name: "Tomate", detail: "Fairy-type Sparkling Lv. 3" },
        ],
      },
      {
        id: "herba-mystica",
        heading: "Como farmar Herba Mystica",
        body: "Herba Mystica é o ingrediente raro que torna possível o Sparkling Lv. 3. A forma mais eficiente de obter é completando Tera Raids de 5★ e 6★. Qualquer raid 5★+ pode dropar qualquer sabor de Herba Mystica — não existe raid específica por sabor.",
        items: [
          { name: "Sweet Herba Mystica", detail: "Drop raro em raids 5★ e 6★" },
          { name: "Salty Herba Mystica", detail: "Drop raro em raids 5★ e 6★" },
          { name: "Spicy Herba Mystica", detail: "Drop raro em raids 5★ e 6★" },
          { name: "Bitter Herba Mystica", detail: "Drop raro em raids 5★ e 6★" },
          { name: "Sour Herba Mystica", detail: "Drop raro em raids 5★ e 6★" },
        ],
      },
      {
        id: "dicas",
        ...
        items: [
          { name: "Shiny Charm", detail: "Adiciona rolls extras de Shiny por encontro — consiga antes de começar o hunt" },
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { name: "Chorizo", detail: "Normal-type Sparkling Lv. 3" },
          { name: "Red Bell Pepper", detail: "Fire-type Sparkling Lv. 3" },
          { name: "Cucumber", detail: "Water-type Sparkling Lv. 3" },
          { name: "Lettuce", detail: "Grass-type Sparkling Lv. 3" },
          { name: "Tomato", detail: "Fairy-type Sparkling Lv. 3" },
        ],
      },
      {
        id: "herba-mystica",
        heading: "How to farm Herba Mystica",
        body: "Herba Mystica is the rare ingredient that enables Sparkling Lv. 3. The most reliable source is completing 5★ and 6★ Tera Raids. Any 5★+ raid can drop any Herba Mystica flavor — there is no specific raid per flavor.",
        items: [
          { name: "Sweet Herba Mystica", detail: "Rare drop from 5★ and 6★ raids" },
          { name: "Salty Herba Mystica", detail: "Rare drop from 5★ and 6★ raids" },
          { name: "Spicy Herba Mystica", detail: "Rare drop from 5★ and 6★ raids" },
          { name: "Bitter Herba Mystica", detail: "Rare drop from 5★ and 6★ raids" },
          { name: "Sour Herba Mystica", detail: "Rare drop from 5★ and 6★ raids" },
        ],
      },
      {
        id: "tips",
        ...
        items: [
          { name: "Shiny Charm", detail: "Adds extra Shiny rolls per encounter — get this before you start hunting" },
