...
export const SHINY_RECIPES: SandwichRecipe[] = [
  ...
  { name: "Shiny Poison", type: "Poison", ingredients: ["Green Bell Pepper x1"], condiments: ["Salty Herba Mystica x2"], powers: ["Sparkling Power: Poison Lv.3", "Encounter Power: Poison Lv.3", "Title Power: Poison Lv.3"], herba: ["Salty", "Salty"] },
