    ...
    >
      ...
      >
        ...
        <div className="absolute right-4 top-4 z-10 flex items-center gap-1">
          {(onPrev || onNext) && (
            <>
              <button
                ...
                disabled={!hasPrev}
                title="Previous (←)"
                className="border border-[var(--pt-border-dim)] bg-[var(--pt-card)] px-2 py-1.5 text-[var(--pt-text-dim)] transition-colors hover:border-[var(--pt-gold)] hover:text-[var(--pt-gold)] disabled:cursor-not-allowed disabled:opacity-30"
              >
                <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
                  <path d="M8 1L3 6l5 5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                </svg>
              </button>
              <button
                onClick={onNext}
              ...
              >
                <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
                  <path d="M4 1l5 5-5 5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                </svg>
              </button>
            </>
          )}
          <button
            onClick={onClose}
            className="border border-[var(--pt-border-dim)] bg-[var(--pt-card)] p-1.5 text-[var(--pt-text-dim)] hover:border-[var(--pt-gold)] hover:text-[var(--pt-gold)]"
          >
