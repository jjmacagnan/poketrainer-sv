...
export function BuyMeCoffeeLink({ variant = 'footer' }: { variant?: 'footer' | 'footer-link' | 'inline' }) {
  ...
  return (
    <a
      ...
      className="flex w-fit items-center gap-2 rounded-none border border-[var(--pt-gold)] bg-[rgba(255,215,0,0.08)] px-3 py-1.5 text-sm text-[var(--pt-gold)] transition-colors hover:border-yellow-500/30 hover:text-yellow-400"
    >
